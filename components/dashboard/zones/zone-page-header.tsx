...
export function ZonePageHeader({
  ...
  return (
    <div className="space-y-6 animate-in fade-in-0 duration-300">
            ...
            <TabsList className="w-full sm:w-auto transition-colors duration-[150ms]">
              {enabledSources.map((source) => (
                <TabsTrigger
                  key={source}
                  value={source}
                  className="transition-all duration-[150ms] data-[state=active]:shadow-sm"
      ...
      {!showTabs && (
        <div className="rounded-lg border border-border bg-muted/30 p-6 animate-in fade-in-0 duration-300">
