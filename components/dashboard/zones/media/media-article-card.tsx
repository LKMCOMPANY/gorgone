          ...
          {hasImage && (
            <div className="relative w-full sm:w-48 h-48 sm:h-auto flex-shrink-0 bg-muted/30 overflow-hidden">
              <img
                ...
                alt={article.title}
                className="w-full h-full object-cover transition-transform duration-[var(--transition-base)] group-hover:scale-105"
      ...
      {expanded && (
        <div className="border-t border-border/60 bg-muted/5 p-4 sm:p-5 space-y-4 animate-in fade-in-0 slide-in-from-top-2 duration-200">
          ...
          {hasConcepts && (
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm font-medium">
                <Tag className="size-4 text-primary flex-shrink-0" />
          ...
          {hasCategories && (
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm font-medium">
                <svg className="size-4 text-primary flex-shrink-0" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
