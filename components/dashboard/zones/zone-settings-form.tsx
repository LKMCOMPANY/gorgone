    ...
    <Tabs defaultValue="general" className="space-y-8">
      <TabsList className="w-full sm:w-auto transition-colors duration-[var(--transition-fast)]">
        ...
        {dataSources.twitter && (
          <TabsTrigger
            value="twitter"
            className="text-sm font-medium transition-all duration-[var(--transition-fast)] data-[state=active]:shadow-sm gap-2"
          >
        ...
        <Card className="card-padding space-y-6 border-border">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="h-9 transition-all duration-[var(--transition-fast)] focus-visible:shadow-[var(--shadow-sm)] focus-visible:ring-2 focus-visible:ring-ring"
            />
            {isSaving && (
          ...
          <div className="flex items-center justify-between rounded-lg border border-border bg-muted/30 p-4 transition-colors duration-[var(--transition-fast)] hover:bg-muted/50">
        ...
        <Card className="card-padding space-y-6 border-border">
          ...
          <div className="space-y-3">
            ...
            <div className="card-interactive flex items-center justify-between rounded-lg border border-border bg-muted/20 p-4 transition-all duration-200 hover:bg-muted/40">
              <div className="flex items-center gap-3">
                <div className="flex size-10 flex-shrink-0 items-center justify-center rounded-full bg-primary/10">
                  <svg className="size-5 text-primary" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="text-lg font-semibold text-destructive flex items-center gap-2">
                  <svg className="size-5" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <Button
                ...
                disabled={isDeleting}
                className="gap-2 transition-all duration-[var(--transition-fast)] hover:shadow-lg"
              >
