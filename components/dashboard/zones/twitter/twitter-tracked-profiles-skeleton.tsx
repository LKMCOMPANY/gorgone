      ...
      <div className="space-y-6">
        <div className="flex gap-2 overflow-x-auto pb-2">
          {[1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div
              key={i}
              className="size-164 flex-shrink-0 skeleton-shimmer rounded-lg"
            />
          ))}
        </div>
        ...
        <Card className="card-padding space-y-6">
          ...
          <div className="space-y-3 pb-6 border-b border-border">
            <div className="flex items-center gap-2">
              <div className="size-60 skeleton-shimmer rounded-full" />
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="size-54 skeleton-shimmer rounded-md" />
              <div className="flex gap-2">
                <div className="h-11 flex-1 skeleton-shimmer rounded-lg" />
                <div className="size-110 skeleton-shimmer rounded-lg" />
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="size-88 skeleton-shimmer rounded-full" />
              ))}
            </div>
          </div>
        </Card>
