    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar/80 backdrop-blur-xl border-r border-sidebar-border/50 group-data-[variant=floating]/sidebar:border-sidebar-border/50 flex h-full w-full flex-col group-data-[variant=floating]/sidebar:rounded-lg group-data-[variant=floating]/sidebar:border group-data-[variant=floating]/sidebar:shadow-sm"
        >
          {children}
        </div>
      </div>
